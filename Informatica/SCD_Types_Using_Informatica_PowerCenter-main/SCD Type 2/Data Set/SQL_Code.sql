...
VALUES (1, 'Michael', 'Scott', '123-456-7890', 80000, TO_DATE('2001-04-01', 'YYYY-MM-DD'), 'Sales', TO_DATE('2024-12-01', 'YYYY-MM-DD'));

INSERT INTO SRC_EMP_SCD2 (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, PHONE_NUMBER, SALARY, HIRE_DATE, DEPARTMENT, SUBMISSION_DATE)
VALUES (2, 'Dwight', 'Schrute', '234-567-8901', 60000, TO_DATE('2004-05-15', 'YYYY-MM-DD'), 'Sales', TO_DATE('2024-12-01', 'YYYY-MM-DD'));

INSERT INTO SRC_EMP_SCD2 (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, PHONE_NUMBER, SALARY, HIRE_DATE, DEPARTMENT, SUBMISSION_DATE)
VALUES (3, 'Jim', 'Halpert', '345-678-9012', 50000, TO_DATE('2006-06-20', 'YYYY-MM-DD'), 'HR', TO_DATE('2024-12-01', 'YYYY-MM-DD'));

INSERT INTO SRC_EMP_SCD2 (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, PHONE_NUMBER, SALARY, HIRE_DATE, DEPARTMENT, SUBMISSION_DATE)
VALUES (4, 'Pam', 'Beesly', '456-789-0123', 45000, TO_DATE('2005-07-10', 'YYYY-MM-DD'), 'HR', TO_DATE('2024-12-01', 'YYYY-MM-DD'));

INSERT INTO SRC_EMP_SCD2 (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, PHONE_NUMBER, SALARY, HIRE_DATE, DEPARTMENT, SUBMISSION_DATE)
VALUES (5, 'Ryan', 'Howard', '567-890-1234', 40000, TO_DATE('2007-01-15', 'YYYY-MM-DD'), 'Marketing', TO_DATE('2024-12-01', 'YYYY-MM-DD'));
